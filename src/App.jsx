...
const FRAME_VARIANTS = [
  {
    id: "ironwood",
    // Dark iron-banded timber — rough grain, barely-lit, iron nail-head corners
    frameBg: [
      "repeating-linear-gradient(3deg, rgba(0,0,0,0.22) 0px, transparent 2px, rgba(0,0,0,0.12) 5px, transparent 9px, rgba(0,0,0,0.07) 13px, transparent 17px)",
      "repeating-linear-gradient(357deg, rgba(60,28,8,0.14) 0px, transparent 4px, rgba(40,18,4,0.09) 8px, transparent 14px)",
      "linear-gradient(172deg, #28180a 0%, #1c1008 28%, #2c1c0c 54%, #181008 78%, #221608 100%)",
    ].join(","),
    framePad: 14, outerBorder: "3px solid #0c0604",
    innerLine: "1px solid rgba(110,72,28,0.28)", innerInset: 7,
    shadow: [
      "0 0 0 2px #080402", "0 0 0 5px rgba(40,22,6,0.45)",
      "inset 0 2px 4px rgba(130,84,34,0.30)", "inset 2px 0 4px rgba(110,70,26,0.18)",
      "inset 0 -6px 12px rgba(0,0,0,0.80)", "inset -6px 0 12px rgba(0,0,0,0.60)",
      "inset 0 0 30px rgba(0,0,0,0.50)",
      "0 6px 20px rgba(0,0,0,0.85)", "0 14px 40px rgba(0,0,0,0.65)",
    ].join(","),
    glow: "rgba(90,56,18,0.22)",
    cornerChar: "◆", cornerColor: "rgba(70,46,18,0.98)", cornerFontSize: 10,
    cornerShadow: "0 1px 0 rgba(150,100,42,0.45), 0 -1px 0 rgba(0,0,0,0.95), 0 0 2px rgba(0,0,0,0.8)",
    cornerRotations: [0,0,0,0],
    imageBg: "radial-gradient(ellipse at 40% 30%, #1a1006, #0a0602)",
    plaqueBg: [
      "repeating-linear-gradient(4deg, rgba(0,0,0,0.18) 0px, transparent 3px, rgba(0,0,0,0.10) 7px, transparent 12px)",
      "repeating-linear-gradient(176deg, rgba(40,22,6,0.10) 0px, transparent 6px, rgba(0,0,0,0.06) 11px, transparent 16px)",
      "linear-gradient(180deg, #241a08 0%, #1a1004 50%, #120c02 100%)",
    ].join(","),
    plaqueBorder: "#3c2410",
    plaqueShadow: "0 5px 16px rgba(0,0,0,0.88), inset 0 1px 0 rgba(130,84,34,0.16), inset 0 -2px 4px rgba(0,0,0,0.70)",
    plaqueText: "#886030", chainColor: "#3c2410", nameColor: "#b08040",
    nameShadow: "0 2px 0 rgba(0,0,0,0.90), 0 0 8px rgba(80,48,12,0.35)",
  },
  {
    id: "tarnished",
    // Tarnished dungeon gold — dull olive-brown with green tarnish pockets, no shine
    frameBg: [
      "repeating-linear-gradient(128deg, rgba(0,0,0,0.12) 0px, transparent 3px, rgba(0,0,0,0.07) 7px, transparent 12px)",
      "repeating-linear-gradient(38deg, rgba(100,80,10,0.10) 0px, transparent 5px, rgba(70,55,8,0.07) 10px, transparent 16px)",
      "repeating-linear-gradient(92deg, rgba(20,30,10,0.08) 0px, transparent 8px, rgba(30,40,12,0.05) 15px, transparent 22px)",
      "linear-gradient(148deg, #5a4c14 0%, #48380e 22%, #3c2e0a 44%, #504014 62%, #382c08 80%, #443610 100%)",
    ].join(","),
    framePad: 13, outerBorder: "2px solid #241c06",
    innerLine: "1px solid rgba(120,96,24,0.25)", innerInset: 6,
    shadow: [
      "0 0 0 1px #1c1404", "0 0 0 4px rgba(60,44,8,0.35)",
      "inset 0 2px 3px rgba(160,130,44,0.26)", "inset 2px 0 3px rgba(138,110,36,0.17)",
      "inset 0 -5px 10px rgba(16,12,2,0.75)", "inset -5px 0 10px rgba(20,14,3,0.58)",
      "inset 0 0 22px rgba(0,0,0,0.40)",
      "0 5px 18px rgba(0,0,0,0.80)", "0 12px 34px rgba(0,0,0,0.58)",
    ].join(","),
    glow: "rgba(120,92,14,0.24)",
    cornerChar: "⚜", cornerColor: "rgba(140,108,28,0.82)", cornerFontSize: 12,
    cornerShadow: "0 1px 0 rgba(0,0,0,0.85), 0 0 4px rgba(80,58,8,0.40)",
    cornerRotations: [0,0,0,0],
    imageBg: "radial-gradient(ellipse at 35% 28%, #1a1408, #0c0a02)",
    plaqueBg: [
      "repeating-linear-gradient(5deg, rgba(0,0,0,0.14) 0px, transparent 3px, rgba(0,0,0,0.08) 7px, transparent 11px)",
      "repeating-linear-gradient(175deg, rgba(60,44,8,0.10) 0px, transparent 6px, rgba(0,0,0,0.05) 11px, transparent 17px)",
      "linear-gradient(180deg, #282008 0%, #1c1604 50%, #141004 100%)",
    ].join(","),
    plaqueBorder: "#5a4810",
    plaqueShadow: "0 4px 16px rgba(0,0,0,0.82), inset 0 1px 0 rgba(140,110,30,0.14), inset 0 -2px 4px rgba(0,0,0,0.65)",
    plaqueText: "#9c7c28", chainColor: "#584810", nameColor: "#c09838",
    nameShadow: "0 2px 0 rgba(0,0,0,0.85), 0 0 8px rgba(100,76,14,0.32)",
  },
  {
    id: "iron",
    // Cold-hammered dark iron — near-black, pitted, faint rust bloom, heavy rivet corners
    frameBg: [
      "repeating-linear-gradient(158deg, rgba(255,255,255,0.015) 0px, transparent 2px, rgba(255,255,255,0.008) 5px, transparent 8px)",
      "repeating-linear-gradient(74deg, rgba(90,44,18,0.08) 0px, transparent 4px, rgba(60,28,12,0.05) 7px, transparent 11px)",
      "repeating-linear-gradient(14deg, rgba(0,0,0,0.14) 0px, transparent 3px, rgba(0,0,0,0.07) 6px, transparent 10px)",
      "linear-gradient(156deg, #303434 0%, #202626 18%, #2a2e2e 36%, #181c1c 52%, #262a2a 70%, #161a1a 86%, #202424 100%)",
    ].join(","),
    framePad: 13, outerBorder: "3px solid #0a0c0c",
    innerLine: "1px solid rgba(70,80,80,0.22)", innerInset: 7,
    shadow: [
      "0 0 0 1px #080a0a", "0 0 0 4px rgba(16,20,20,0.55)",
      "inset 0 2px 3px rgba(90,100,100,0.24)", "inset 2px 0 3px rgba(75,85,85,0.15)",
      "inset 0 -5px 10px rgba(0,0,0,0.82)", "inset -5px 0 10px rgba(0,0,0,0.65)",
      "inset 0 0 26px rgba(0,0,0,0.45)",
      "0 6px 18px rgba(0,0,0,0.88)", "0 12px 36px rgba(0,0,0,0.68)",
    ].join(","),
    glow: "rgba(70,50,28,0.18)",
    cornerChar: "◉", cornerColor: "rgba(78,88,88,0.90)", cornerFontSize: 12,
    cornerShadow: "0 1px 0 rgba(0,0,0,0.95), 0 -1px 0 rgba(110,124,124,0.18), 0 0 2px rgba(0,0,0,0.80)",
    cornerRotations: [0,0,0,0],
    imageBg: "radial-gradient(ellipse at 35% 28%, #141616, #080a0a)",
    plaqueBg: [
      "repeating-linear-gradient(2deg, rgba(0,0,0,0.20) 0px, transparent 3px, rgba(0,0,0,0.11) 6px, transparent 10px)",
      "repeating-linear-gradient(178deg, rgba(20,24,24,0.18) 0px, transparent 5px, rgba(0,0,0,0.08) 9px, transparent 14px)",
      "linear-gradient(180deg, #1c2020 0%, #121616 50%, #0c1010 100%)",
    ].join(","),
    plaqueBorder: "#2e3838",
    plaqueShadow: "0 4px 16px rgba(0,0,0,0.92), inset 0 1px 0 rgba(90,104,104,0.10), inset 0 -2px 4px rgba(0,0,0,0.75)",
    plaqueText: "#6a8484", chainColor: "#2e3838", nameColor: "#8aa4a4",
    nameShadow: "0 2px 0 rgba(0,0,0,0.95), 0 0 6px rgba(70,88,88,0.28)",
  },
  {
    id: "verdigris",
    // Ancient dungeon bronze — centuries of green-black patina, corroded, pitted
    frameBg: [
      "repeating-linear-gradient(146deg, rgba(0,0,0,0.16) 0px, transparent 3px, rgba(28,55,16,0.10) 6px, transparent 10px)",
      "repeating-linear-gradient(54deg, rgba(36,64,20,0.12) 0px, transparent 4px, rgba(0,0,0,0.08) 8px, transparent 14px)",
      "repeating-linear-gradient(8deg, rgba(0,0,0,0.12) 0px, transparent 5px, rgba(20,40,10,0.07) 9px, transparent 14px)",
      "linear-gradient(148deg, #263c18 0%, #1a2c12 22%, #2e2808 40%, #142014 58%, #221a08 74%, #0c180a 88%, #1a2010 100%)",
    ].join(","),
    framePad: 13, outerBorder: "2px solid #0c1208",
    innerLine: "1px solid rgba(66,110,40,0.22)", innerInset: 6,
    shadow: [
      "0 0 0 1px #080e06", "0 0 0 4px rgba(16,34,10,0.45)",
      "inset 0 2px 3px rgba(88,144,54,0.18)", "inset 2px 0 3px rgba(70,124,44,0.12)",
      "inset 0 -5px 10px rgba(4,12,2,0.76)", "inset -5px 0 10px rgba(6,16,4,0.60)",
      "inset 0 0 24px rgba(0,0,0,0.42)",
      "0 5px 18px rgba(0,0,0,0.82)", "0 12px 34px rgba(0,0,0,0.60)",
    ].join(","),
    glow: "rgba(58,108,30,0.22)",
    cornerChar: "⊕", cornerColor: "rgba(72,128,44,0.80)", cornerFontSize: 13,
    cornerShadow: "0 1px 0 rgba(0,0,0,0.82), 0 0 4px rgba(40,88,20,0.32)",
    cornerRotations: [0,0,0,0],
    imageBg: "radial-gradient(ellipse at 35% 28%, #141608, #080a02)",
    plaqueBg: [
      "repeating-linear-gradient(3deg, rgba(0,0,0,0.16) 0px, transparent 3px, rgba(16,28,8,0.10) 7px, transparent 11px)",
      "repeating-linear-gradient(177deg, rgba(20,36,10,0.12) 0px, transparent 6px, rgba(0,0,0,0.06) 10px, transparent 16px)",
      "linear-gradient(180deg, #181c06 0%, #101406 50%, #0c1004 100%)",
    ].join(","),
    plaqueBorder: "#2e4c1e",
    plaqueShadow: "0 4px 16px rgba(0,0,0,0.85), inset 0 1px 0 rgba(80,136,48,0.12), inset 0 -2px 4px rgba(0,0,0,0.68)",
    plaqueText: "#6a9c40", chainColor: "#2e4c1e", nameColor: "#88bb54",
    nameShadow: "0 2px 0 rgba(0,0,0,0.90), 0 0 7px rgba(56,104,26,0.38)",
  },
  {
    id: "blackwood",
    // Blackened ancient timber with flaking gold-leaf inlay — a warlord's war trophy
    frameBg: [
      "repeating-linear-gradient(6deg, rgba(0,0,0,0.28) 0px, transparent 2px, rgba(0,0,0,0.16) 4px, transparent 8px, rgba(0,0,0,0.09) 12px, transparent 16px)",
      "repeating-linear-gradient(174deg, rgba(110,76,14,0.10) 0px, transparent 5px, rgba(80,52,8,0.06) 10px, transparent 17px)",
      "repeating-linear-gradient(90deg, rgba(0,0,0,0.08) 0px, transparent 12px, rgba(0,0,0,0.05) 18px, transparent 26px)",
      "linear-gradient(170deg, #1a1406 0%, #100c02 26%, #181202 50%, #0e0a02 74%, #161004 100%)",
    ].join(","),
    framePad: 15, outerBorder: "3px solid #080602",
    innerLine: "1px solid rgba(140,100,20,0.30)", innerInset: 8,
    shadow: [
      "0 0 0 2px #060402", "0 0 0 6px rgba(60,40,6,0.25)",
      "inset 0 2px 4px rgba(148,104,28,0.24)", "inset 2px 0 4px rgba(124,86,20,0.15)",
      "inset 0 -6px 14px rgba(0,0,0,0.88)", "inset -6px 0 14px rgba(0,0,0,0.70)",
      "inset 0 0 34px rgba(0,0,0,0.55)",
      "0 7px 22px rgba(0,0,0,0.90)", "0 16px 44px rgba(0,0,0,0.70)",
    ].join(","),
    glow: "rgba(140,96,14,0.18)",
    cornerChar: "❧", cornerColor: "rgba(148,106,24,0.86)", cornerFontSize: 14,
    cornerShadow: "0 1px 0 rgba(0,0,0,0.90), 0 -1px 0 rgba(180,136,38,0.18), 0 0 4px rgba(100,68,8,0.32)",
    cornerRotations: [0, 90, 270, 180],
    imageBg: "radial-gradient(ellipse at 36% 28%, #181006, #0a0602)",
    plaqueBg: [
      "repeating-linear-gradient(5deg, rgba(0,0,0,0.24) 0px, transparent 2px, rgba(0,0,0,0.14) 5px, transparent 9px, rgba(0,0,0,0.08) 13px, transparent 18px)",
      "repeating-linear-gradient(175deg, rgba(80,54,8,0.12) 0px, transparent 6px, rgba(0,0,0,0.07) 11px, transparent 17px)",
      "linear-gradient(180deg, #181202 0%, #0e0a02 50%, #0a0802 100%)",
    ].join(","),
    plaqueBorder: "#483408",
    plaqueShadow: "0 5px 18px rgba(0,0,0,0.95), inset 0 1px 0 rgba(148,104,28,0.14), inset 0 -2px 4px rgba(0,0,0,0.75)",
    plaqueText: "#9a7228", chainColor: "#483408", nameColor: "#c49038",
    nameShadow: "0 2px 0 rgba(0,0,0,0.95), 0 0 8px rgba(120,80,10,0.30)",
  },
];
